...
import com.example.fitness.equipment.Equipment;
...
public class EquipmentExcelUtil {
    private static final String FILE_PATH = "C:\\Users\\1345144699\\IdeaProjects\\fitness\\src\\main\\java\\com\\example\\fitness\\equipment\\Equipment(1).xlsx";
    ...
    public static List<Equipment> readExcel() throws IOException {
        ...
        for (Row row : sheet) {
            ...
            Date purchaseDate = row.getCell(6).getDateCellValue();
